...
w_i = np.array([5*10**8,5*10**8,5*10**8,5*10**8])
...
print('Ouput',output,output.shape)
#Zip the three values together?
print(len(r_squeeze))
print(output[0]) #This prints the first term, three values
